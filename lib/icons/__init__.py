...
def icon_to_image(name, fill=None, scale_to_width=None, scale_to_height=None, scale=1):
    ...
    img_data = svg_to_image(name, xml_data, fill, scale_to_width, scale_to_height, scale)
    return img_data


def svg_to_image(name, source, fill=None, scale_to_width=None, scale_to_height=None, scale=1):
    ...
    with open(ResourceLocation(f"assets/icons/{name}.svg"), "wb") as f:
        f.write(kw["data"])
